 ...
 */
EAPI Eina_Stringshare* ewk_policy_decision_cookie_get(const Ewk_Policy_Decision* policy_decision);
 ...
 */
EAPI Eina_Stringshare* ewk_policy_decision_userid_get(const Ewk_Policy_Decision* policy_decision);
 ...
 */
EAPI Eina_Stringshare* ewk_policy_decision_password_get(const Ewk_Policy_Decision* policy_decision);
 ...
 */
EAPI Eina_Stringshare* ewk_policy_decision_url_get(Ewk_Policy_Decision* policy_decision);
 ...
 */
EAPI Eina_Stringshare* ewk_policy_decision_scheme_get(Ewk_Policy_Decision* policy_decision);
 ...
 */
EAPI Eina_Stringshare* ewk_policy_decision_host_get(Ewk_Policy_Decision* policy_decision);
 ...
 */
EAPI Eina_Stringshare* ewk_policy_decision_response_mime_get(const Ewk_Policy_Decision* policy_decision);
