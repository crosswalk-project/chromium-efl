...
TEST_F(utc_blink_ewk_back_forward_list_n_forward_items_copy, LESS_ITEMS_TEST)
{
  ...
  Eina_List *fwd_list = ewk_back_forward_list_n_forward_items_copy(list, 1);
  ASSERT_TRUE(fwd_list);
  ASSERT_EQ(1, eina_list_count(fwd_list));

  // get the only item and check URL, original URL and title
  Ewk_Back_Forward_List_Item *item = static_cast<Ewk_Back_Forward_List_Item *>(fwd_list->data);
...
TEST_F(utc_blink_ewk_back_forward_list_n_forward_items_copy, EQUAL_ITEMS_TEST)
{
  ...
  Eina_List *forward_list = ewk_back_forward_list_n_forward_items_copy(list, 2);
  ASSERT_TRUE(forward_list);
  ASSERT_EQ(2, eina_list_count(forward_list));

  // get first item and check URL, original URL and title
  Ewk_Back_Forward_List_Item *item = static_cast<Ewk_Back_Forward_List_Item *>(forward_list->data);
  ...
  item = static_cast<Ewk_Back_Forward_List_Item *>(forward_list->next->data);
  ...
  forward_list = ewk_back_forward_list_n_forward_items_copy(list, -1);
  ASSERT_TRUE(forward_list);
  ASSERT_EQ(2, eina_list_count(forward_list));

  // get first item and check URL, original URL and title
  item = static_cast<Ewk_Back_Forward_List_Item *>(forward_list->data);
...
TEST_F(utc_blink_ewk_back_forward_list_n_forward_items_copy, MORE_ITEMS_TEST)
{
  ...
  Eina_List *fwd_list = ewk_back_forward_list_n_forward_items_copy(list, 10);
  ASSERT_TRUE(fwd_list);
  ASSERT_EQ(2, eina_list_count(fwd_list));
  ...
  // get second item and check URL, original URL and title
  item = static_cast<Ewk_Back_Forward_List_Item *>(fwd_list->next->data);
