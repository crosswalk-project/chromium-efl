...
class utc_blink_ewk_back_forward_list_item_title_get : public utc_blink_ewk_base
{
protected:
...
const char* const utc_blink_ewk_back_forward_list_item_title_get::TEST_URL1 = "ewk_history/page1.html";
const char* const utc_blink_ewk_back_forward_list_item_title_get::TEST_URL2 = "ewk_history/page2.html";
const char* const utc_blink_ewk_back_forward_list_item_title_get::TEST_URL3 = "ewk_history/page3.html";

TEST_F(utc_blink_ewk_back_forward_list_item_title_get, POS_TEST)
{
...
TEST_F(utc_blink_ewk_back_forward_list_item_title_get, NULL_TEST)
{
  ASSERT_FALSE(ewk_back_forward_list_item_title_get(NULL));
}
